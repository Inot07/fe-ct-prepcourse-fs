...
function devolverUltimoElemento(array) {
   ...
   // Tu código:
   let arreglo = array[array.length - 1];
   return arreglo;
}
...
function incrementarPorUno(array) {
   ...
   // Tu código:
   let sumas = array.map (function(incrementar){return incrementar + 1});
   return sumas;
}
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   let numeroMax = Math.max(...arrayOfNums);
   return numeroMax;
}
...
function cuentoElementos(array) {
   ...
   // Tu código:
   let mayorQue = array.filter(function(elemento) {
      return elemento > 18;
   });

   let elementosMayores = mayorQue.length;
...
function empiezaConNueve(num) {
   ...
   return cadenaNumero.charAt(0) === '9';
}
...
function mayorACien(array) {
   ...
   // Tu código:
   var mayora100 = array.filter(function(num) {
      return num > 100;
   });
   return mayora100;
}

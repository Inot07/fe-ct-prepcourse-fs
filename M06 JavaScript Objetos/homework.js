...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var objet = {nombre: nombre, edad: edad}
   objet.meow = function retornarMeow() {
      return "Meow!";
   }
   return objet;
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var objet = {nombre: nombre, email: email, password: password}
   return objet;
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   for(let numero in objetoMisterioso) {
     return objetoMisterioso[numero] * 5;
   }
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   // El "objetoProducto" posee una propiedad "precio" y una propiedad "calcularPrecioDescuento".
